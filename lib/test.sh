...
python -u translate.py -k 10 'models/e2e_model.npz' '../data/dictionary.txt' '../data/online-test.pkl' '../data/test_caption.txt' './result/test_dcode_result.txt' './result/test.wer'

python -u ./translate.py -k 10 ./models/e2e_model_unix.npz ../data/dictionary.txt ../data/online-test.pkl ../data/test_caption.txt ./result/test_decode_result.txt ./result/test.wer
